...
export default function Hero({ isArabic, onExploreClick, onAiClick }: HeroProps) {
  return (
    <div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center text-center lg:text-left" style={{ direction: isArabic ? 'rtl' : 'ltr' }}>
            ...
            <motion.p
              ...
              className="text-xs sm:text-sm text-slate-500 leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0 font-medium"
            >
              {isArabic
                ? 'ندمج التصميم الراقي والموضة الحصرية مع تجارب التسوق المستقبلية. استكشف فئات الملابس، العناية الطبيعية، والمستلزمات الفنية المنتقاة بعناية لتعكس فخامة ذوقك.'
                : 'Merging state-of-the-art interactive 3D concepts with silent luxury. Browse masterfully tailored apparel, premium organic wellness, artisan home decor, and bespoke tech accessories.'}
            </motion.p>
          ...
          {/* Image visual display card - overlapping/interlacing down */}
          <motion.div
          ...
          >
            ...
            >
              {/* The user-provided hero image */}
              <img
                src="/src/assets/images/zewka_hero_1783494370864.jpg"
                alt="ZEWKA Boutique Interactive 3D Display"
                referrerPolicy="no-referrer"
                className="w-full h-auto object-cover aspect-[4/3] sm:aspect-[1.4/1]"
              />
